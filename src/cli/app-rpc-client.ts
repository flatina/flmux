...
export interface AppRpcClient {
  call<Method extends AppRpcMethod>(method: Method, params: AppRpcParams<Method>): Promise<AppRpcResult<Method>>;
}

export function createAppRpcClient(endpoint: RpcEndpoint): AppRpcClient {
  return {
    call<Method extends AppRpcMethod>(method: Method, params: AppRpcParams<Method>): Promise<AppRpcResult<Method>> {
      return callJsonRpc<AppRpcResult<Method>>(endpoint, method, params);
    }
  };
}
