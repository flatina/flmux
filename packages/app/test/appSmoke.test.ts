...
describe("flmux app smoke", () => {
  it("boots the real app, switches workspace, and opens a browser pane", async () => {
  ...
  it("resets a workspace through the header action and kills attached runtimes", async () => {
